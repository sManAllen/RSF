    ...
    extends AbstractTableModel
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6051661655693605592L;
    ...
    public static final String[] COL_NAMES = {
        "时间", "优先级", "Trace", "Category", "NDC", "消息"};
    
    public static final int[] COL_WIDTH={ 150, 100, 50, 150, 50, 2000 };
    ...
    public Object getValueAt(int aRow, int aCol) {
        synchronized (mLock) {
            ...
            if (aCol == 0) {
                return Application.GetYMDHMSFormatString(new Date(event.getTimeStamp()));
            } else if (aCol == 1) {
    ...
    private void updateFilteredEvents(boolean aInsertedToFront) {
        final ArrayList<EventDetails> filtered = new ArrayList<EventDetails>();
