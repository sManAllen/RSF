...
class EventDetails {
     ...
     * @param aMessage
     *            a <code>String</code> value
     * @param aThrowableStrRep
     *            a <code>String[]</code> value
     * @param aLocationDetails
     *            a <code>String</code> value
     */
    ...
    EventDetails(LoggingEvent aEvent) {
        ...
        this(aEvent.timeStamp, aEvent.getLevel(), aEvent.getLoggerName(), aEvent.getNDC(), aEvent.getThreadName(),
            aEvent.getRenderedMessage(), aEvent.getThrowableStrRep(), (aEvent.getLocationInformation() == null) ? null
