...
class LoadXMLAction extends AbstractAction {
	 ...
	 * 
	 */
    private static final long serialVersionUID = 5612961861239899793L;
    
    /** 日志对象 */
    private static Logger logger = Logger.getLogger(LoadXMLAction.class);
    
    /** the parent frame **/
    private final JFrame mParent;
    
    /**
     * the file chooser - configured to allow only the selection of a single
     * file.
     */
     ...
     * 
     * @param aFile
     *            the file to extract events from
